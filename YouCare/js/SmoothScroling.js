...
var sections = document.querySelectorAll(".scroll-snap-section");
...
function reScroll() {
  if (scrolled) {
    ...
    for (let index = 0; index < sections.length; index++) {
      ...
      if (sectionTop === CurrentScrollTop) {
        break;
      }

      if (sectionTop > 0) {
        if (sectionTop - CurrentScrollTop < window.innerHeight * 0.4) {
          window.scrollTo(0, sectionTop + CurrentScrollTop);
        }
        break;
      }
    }
